...
ClapTrap::ClapTrap(string const &name) : m_name(name), m_attackDamage(0),
...
ClapTrap::ClapTrap(string const &name, int HP, int EP, int AD) : m_name(name),
...
void 	ClapTrap::setAD(int ad) { m_attackDamage = ad; }

void 	ClapTrap::setName(const string &name) { m_name = name; }

void 	ClapTrap::setHP(int hp) { m_hitPoints = hp; }

void 	ClapTrap::setEP(int ep) { m_energyPoints = ep; }
